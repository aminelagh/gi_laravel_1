...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">G-I</a>
    ...
    <div class="container my-auto">
      <div class="row">
        ...
        <div class="col-lg-8 mx-auto">
          <p class="text-faded mb-5">G-I</p>
          <a class="btn btn-primary btn-xl js-scroll-trigger" href="{{route('login')}}">Commencer</a>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mx-auto text-center">
          <h2 class="section-heading text-white">Gestion des interventions</h2>
          <hr class="light my-4">
          <p class="text-faded mb-4">Description de l'application ici</p>
        </div>
      </div>
    </div>
  </section-->
